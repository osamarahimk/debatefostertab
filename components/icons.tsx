...
export const GavelIcon: React.FC<IconProps> = ({ className = "w-6 h-6" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M14.121 7.629A3 3 0 009.88 9.88l5.657 5.657a3 3 0 002.249-4.328l-5.666-3.58z" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M6.343 17.657l3.536-3.536m2.828-2.829l-2.121-2.121-2.122 2.121 2.122 2.121zM3 21l3.536-3.536" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M17.657 6.343L12 12m0 0l-2.121 2.121" />
    </svg>
);
...
export const EnterFullscreenIcon: React.FC<IconProps> = ({ className = "w-5 h-5" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
...
export const ExitFullscreenIcon: React.FC<IconProps> = ({ className = "w-5 h-5" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M9 9L3.75 3.75M3.75 3.75v4.5m0-4.5h4.5m12 12L15 15m0 0v-4.5m0 4.5h-4.5M9 15l-4.5 4.5m0 0v-4.5m0 4.5h4.5M15 9l4.5-4.5m0 0v4.5m0-4.5h-4.5" />
    </svg>
);
